{
  programs.tmux.extraConfig = ''
    ...
    # bind -n M-k run-shell -b "$CONFIG/tmux/plugins/tmux-fzf/scripts/window.sh switch"
    ...
    bind -n M-s run-shell -b "/nix/store/j5x6jsrz09199bvvms6m9yxgiqzxaflr-tmuxplugin-resurrect-unstable-2022-05-01/share/tmux-plugins/resurrect/scripts/save.sh"
    ...
    # KO
    bind -n M-S-s set-option status       # toggle status bar  KO
