{ config, inputs, lib, pkgs, ... }:{ 
  ...
  xdg.configFile."yt-x/yt-x.conf".text = ''
    ...
    PREFERRED_BROWSER: firefox:/home/lunics/usb_copy/homelab/share/browser/zen/lunics   # browser's profile use to extract cookies from, used to by yt-dlp to access content that would require login
