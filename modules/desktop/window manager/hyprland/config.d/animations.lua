...
local animation = {
  ...
  { leaf = "fadeLayersIn",  enabled = false, speed = 1.79, bezier = "almostLinear" },
  { leaf = "fadeLayersOut", enabled = false, speed = 1.39, bezier = "almostLinear" },
  { leaf = "workspaces",    enabled = false, speed = 1.94, bezier = "almostLinear", style = "fade" },
