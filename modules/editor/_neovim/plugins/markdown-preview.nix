{ _config, ... }:{
  ...
  extraConfigVim = ''
    " 1 = nvim will open the preview window after entering the Markdown buffer
    let g:mkdp_auto_start = 0
    
    " 1 = the nvim will auto close current preview window when changing from Markdown buffer to another buffer
    let g:mkdp_auto_close = 1
    
    " 1 = Vim will refresh Markdown when saving the buffer or
